                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="m-0">Usuarios 
                            <button class="btn btn-primary" onclick="nuevo()"><i class="fas fa-user"></i> Nuevo</button>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover table-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                            <button type="button" class="btn btn-success btn-sm editar" onclick="editar({{ $usuario->id }})">
                                                <i class="fas fa-edit"></i>
                                            </button>
                                                <button type="button" class="btn btn-danger btn-sm eliminar" onclick="eliminar({{ $usuario->id }})">
